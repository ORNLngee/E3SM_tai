module ColumnDataType
  ...
  type, public :: column_water_state
    ...
    ! TAI system
    real(r8), pointer :: salinity           (:)   => null() ! tidal salinity
    real(r8), pointer :: h2osfc_tide        (:)   => null() ! tidal height above surface
    real(r8), pointer :: nitrate_tide       (:)   => null() ! tidal water nitrate concentration (mol/L)
...
contains
  ...
  subroutine col_wf_init(this, begc, endc)
    ...
    this%qflx_drain_vr       (begc:endc, :) = 0._r8
